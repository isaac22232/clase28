...
var backgroundM, explosionm, aguaM, risam;
...
function preload() {
  ...
  explosionm=loadSound("assets/cannon_explosion.mp3")
  aguaM=loadSound("assets/cannon_water.mp3")
  risam=loadSound("assets/pirate_laugh.mp3")
}
